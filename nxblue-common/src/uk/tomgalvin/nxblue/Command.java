...
import uk.tomgalvin.nxblue.util.ArrayMap;
import uk.tomgalvin.nxblue.util.StringUtil;

/**
 * A simple class that allows a command (with a name, as a string, along with
...
public class Command {
	...
	private final ArrayMap<String, CommandParameter> params;
	
	/**
	 * Initialize a new Command object with the given command name.
	 * 
	 * @param commandName The name of the command.
	 */
	public Command(String commandName) {
		this.commandName = commandName;
		this.params = new ArrayMap<String, CommandParameter>();
	}
	...
	/**
	 * Gets a list of all the parameters contained within this command.
	 * 
	 ...
	 */
	public Command setString(String paramName, String value) {
	 ...
	 * @throws IllegalArgumentException When the parameter already exists.
	 */
	public Command setInteger(String paramName, int value) {
	 ...
	 * @throws IllegalArgumentException When the parameter already exists.
	 */
	public Command setLong(String paramName, long value) {
	 ...
	 * @throws IllegalArgumentException When the parameter already exists.
	 */
	public Command setFloat(String paramName, float value) {
	 ...
	 * @throws IllegalArgumentException When the parameter already exists.
	 */
	public Command setDouble(String paramName, double value) {
	 ...
	 * @throws IllegalArgumentException When the parameter already exists.
	 */
	public Command setBoolean(String paramName, boolean value) {
	...
	private static class CommandParameter {
		 ...
		 * allowable types in a {@link Command} object.
		 * 
		...
		public String toString() {
			if(getValue() == null) {
				...
				return getType().toCommandString() + "`:" + getValue();
			}
		}
		...
		public static CommandParameter fromString(String string) {
			if(StringUtil.endsWith(string, "`!")) {
				...
				CommandParameterType type = CommandParameterType.fromString(typeString);
				String value = string.substring(separatorIndex + 2);
	...
	public static enum CommandParameterType {
		...
		/**
		 * Create a new variant of the {@link Command} enum.
		 * 
		 ...
		 * serialized form of a {@link Command}.
		 * 
